...
public record Network(FTFRiverCarver riverCarver, Wetland[] wetlands, Network[] children, Boundsf bounds) {
    ...
    private static boolean overlaps(River river, FTFRiverCarver riverCarver, float extend) {
    ...
    public static Builder builder(FTFRiverCarver carver) {
        return new Builder(carver);
    }
    
    public static class Builder {
        public FTFRiverCarver carver;
        ...
        private Builder(FTFRiverCarver carver) {
