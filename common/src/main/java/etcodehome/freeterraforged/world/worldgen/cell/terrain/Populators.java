...
import etcodehome.freeterraforged.world.worldgen.biome.BiomeParameter;
...
import etcodehome.freeterraforged.world.worldgen.cell.terrain.populator.OceanPopulator;
...
public class Populators {
	...
	public static Noise makeFancy(@Deprecated Seed seed, Noise input) {
		...
		Noise erosion = Noises.erosion(input, seed.next(), 2, DEFAULT_EROSION_STRENGTH, 128.0F, 0.15F, 3.1F, 0.8F, etcodehome.freeterraforged.world.worldgen.noise.module.Erosion.BlendMode.CONSTANT);
